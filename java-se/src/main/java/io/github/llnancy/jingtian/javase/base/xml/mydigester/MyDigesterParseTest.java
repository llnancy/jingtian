...
public class MyDigesterParseTest {
    public static void main(String[] args) throws ParserConfigurationException, SAXException, IOException {
        ...
        **/
        ...
        // 指定策略
        myDigester.addObjectCreate("Foo", "io.github.llnancy.jingtian.mydigester.xml.base.javase.Foo");
        myDigester.addObjectCreate("Bar", "io.github.llnancy.jingtian.mydigester.xml.base.javase.Bar");
        myDigester.addSetProperties("Bar");
        myDigester.addInvokeMethod("Bar", "addBar", "io.github.llnancy.jingtian.mydigester.xml.base.javase.Bar");
