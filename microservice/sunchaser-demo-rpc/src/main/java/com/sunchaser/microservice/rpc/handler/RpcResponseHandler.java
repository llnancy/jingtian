...
public class RpcResponseHandler extends SimpleChannelInboundHandler<Message<Response>> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, Message<Response> msg) throws Exception {
        RpcFuture rpcFuture = RpcResponseHolder.RPC_FUTURE_MAP.remove(msg.getHeader().getMessageId());
        ...
        rpcFuture.getPromise().setSuccess(response.getData());
    }

    public static class RpcResponseHolder {
        ...
        public RpcResponseHolder(Channel channel) {
