...
/**
 * topic exchange 直接类型交换机 消息消费者：绑定队列 Q2
 *
...
public class TopicReceiveLogsInFile {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DeliverCallback deliverCallback = (consumerTag, delivery) -> {
            ...
            File file = new File("/Users/llnancy/workspace/llnancy-projects/jingtian/middleware/mq/rabbitmq-sample/src/main/resources/topic_log.txt");
