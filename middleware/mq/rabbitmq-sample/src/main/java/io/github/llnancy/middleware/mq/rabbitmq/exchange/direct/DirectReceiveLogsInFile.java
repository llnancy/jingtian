...
/**
 * direct exchange 直接类型交换机 消息消费者：消费 error 日志消息后将消息内容写入文件
 *
...
public class DirectReceiveLogsInFile {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DeliverCallback deliverCallback = (consumerTag, delivery) -> {
            ...
            File file = new File("/Users/llnancy/workspace/llnancy-projects/jingtian/middleware/mq/rabbitmq-sample/src/main/resources/direct_log.txt");
