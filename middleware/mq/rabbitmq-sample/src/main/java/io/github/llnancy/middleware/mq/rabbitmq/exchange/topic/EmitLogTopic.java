...
public class EmitLogTopic {
    ...
    public static void main(String[] args) throws Exception {
        try (Channel channel = RabbitMqHelper.getChannel()) {
            ...
            bindingKeyMap.put("quick.orange.rabbit", "被队列 Q1 Q2 接收\n");
            bindingKeyMap.put("lazy.orange.elephant", "被队列 Q1 Q2 接收\n");
            bindingKeyMap.put("quick.orange.fox", "被队列 Q1 接收\n");
            bindingKeyMap.put("lazy.brown.fox", "被队列 Q2 接收\n");
            bindingKeyMap.put("lazy.pink.rabbit", "虽然满足两个绑定但只会被队列 Q2 接收一次\n");
            bindingKeyMap.put("quick.brown.fox", "没有队列接收，丢弃\n");
            bindingKeyMap.put("quick.orange.male.rabbit", "没有队列接收，丢弃\n");
            bindingKeyMap.put("lazy.orange.male.rabbit", "被队列 Q2 接收\n");
